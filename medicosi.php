...
<div class="row">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
		...
		$metodos->execute("INSERT INTO ADMINCITAS.MEDICOS VALUES ('$cedula','$nombre','$edad','$direccion')");
	    ...
	    $metodos->execute("UPDATE ADMINCITAS.MEDICOS SET ME_NOMBRE = '$nombre', ME_EDAD = '$edad', ME_DIRECCION = '$direccion' WHERE ME_CEDULA = '$cedula'");
		?>
	    ...
	    $metodos->execute("DELETE FROM ADMINCITAS.MEDICOS WHERE ME_CEDULA = '$cedula'");
		?>
	...
	$stm = $metodos->read("SELECT * FROM ADMINCITAS.MEDICOS");
	$stm2 = $metodos->read2("SELECT * FROM ADMINCITAS.MEDICOS");
 ?>
<div class="col-lg-4">
