...
<div class="row">
	...
	<div class="col-lg-4">
      ...
      <div class="input-group-prepend">
        ...
        <select name="nombre" id="nombre" class="custom-select" id="inputGroupSelect01">
          <?php
          $stmoption = $metodos->read("SELECT * FROM ADMINCITAS.PAIS");
          $stmoption2 = $metodos->read2("SELECT * FROM ADMINCITAS.PAIS");
          ...
          ?>
		   ...
		   <div class="form-group">
		    ...
		    <input  name="edad" type="text" class="form-control" id="edad" aria-describedby="emailHelp" placeholder="Ciudad">
		  </div>
    ...
    //echo "INSERT INTO ADMINCITAS.CIUDAD  VALUES ('$cedula','$nombre','$edad')";
		$metodos->execute("INSERT INTO ADMINCITAS.CIUDAD  VALUES ('$cedula','$nombre','$edad')");
      ...
      // echo "UPDATE ADMINCITAS.CIUDAD  SET PA_ID  = '$nombre', CIU_DESCRIPCION = '$edad' WHERE CIU_ID = '$cedula'";
	    $metodos->execute("UPDATE ADMINCITAS.CIUDAD  SET PA_ID  = '$nombre', CIU_DESCRIPCION = '$edad' WHERE CIU_ID = '$cedula'");
		?>
	    ...
	    $metodos->execute("DELETE FROM ADMINCITAS.CIUDAD  WHERE CIU_ID = '$cedula'");
		?>
	...
	$stm = $metodos->read("SELECT * FROM ADMINCITAS.CIUDAD ");
	$stm2 = $metodos->read2("SELECT * FROM ADMINCITAS.CIUDAD ");
 ?>
<div class="col-lg-4">
