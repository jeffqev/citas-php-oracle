...
<div class="row">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
		...
		$metodos->execute("INSERT INTO ADMINCITAS.RECEPCIONISTA VALUES ('$cedula','$nombre','$edad','$direccion')");
	    ...
	    $metodos->execute("DELETE FROM ADMINCITAS.RECEPCIONISTA WHERE RES_CEDULA = '$cedula'");
		?>
	...
	$stm = $metodos->read("SELECT * FROM ADMINCITAS.RECEPCIONISTA");
	$stm2 = $metodos->read2("SELECT * FROM ADMINCITAS.RECEPCIONISTA");
 ?>
<div class="col-lg-4">
